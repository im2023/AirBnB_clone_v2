...
class DBStorage:
    ...
    def __init__(self):
        """Instantiating the DBStorage object"""
    ...
    def save(self):
        """commit all the changes of current database session"""
    ...
    def close(self):
        """calling the remove method on private session attribute"""
